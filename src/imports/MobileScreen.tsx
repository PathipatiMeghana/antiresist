import svgPaths from "./svg-q2eela3eb3";
...
function SplashScreen() {
  return (
    <div className="h-[375.867px] overflow-clip relative shrink-0 w-full" data-name="SplashScreen" style={{ backgroundImage: "linear-gradient(137.277deg, rgb(43, 127, 255) 0%, rgb(21, 93, 252) 50%, rgb(20, 71, 230) 100%)" }}>
      <Container />
      <Heading />
      <Heading1 />
      <Paragraph />
...
export default function MobileScreen() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="MobileScreen">
      <SplashScreen />
    </div>
  );
}